                    ...
                    <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                        <div class="input-group">
                            <select name="search" class="form-control">
                                <option value="{{ $search ? $search : 'All' }}">{{ $search ? $search : 'All' }}</option>
                            ...
                            <span class="input-group-btn">
                                <a class="btn btn-secondary" href="{{ route('admission') }}">Add New!</a>
                            </span>
                        </div>
                    </div>
                </div>
                                    ...
                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-lowercase"><img src="{{ asset('admin_profile_photo/' . $item->profile_photo) }}" alt="{{ $item->profile_photo }}" style="width: 3em;">
                                                </td>

                                                <td>
                                                    <a href="{{ url('admission_edit/' . Crypt::encrypt($item->id)) }}" class="btn btn-info btn-xs">
